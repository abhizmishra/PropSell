...
export default function About() {
  return (
    <div className="py-20 px-4 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold mb-4 text-slate-800">PropSell</h1>
      <p className="mb-4 text-slate-700">
        PropSELL is a real estate agency that specializes in helping clients
      ...
      <p>
        ...
        <a
          ...
          href="https://mail.google.com/mail/?view=cm&fs=1&to=sonusamda@gmail.com&su=More detailed information about PropSell &body=BODY&bcc="
        >
          sonusamda@gmail.com
        </a>
      </p>
